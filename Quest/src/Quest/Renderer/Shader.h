...
namespace Quest
{
	...
	public:
		...
		virtual void SetFloat2(const uint32_t& id, const glm::vec2& value) = 0;
		virtual void SetFloat3(const uint32_t& id, const glm::vec3& value) = 0;
		virtual void SetFloat4(const uint32_t& id, const glm::vec4& value) = 0;
